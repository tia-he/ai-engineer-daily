...
export default function Masthead() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-rule bg-surface/80 backdrop-blur-md">
      <div className="mx-auto flex w-full max-w-3xl items-center justify-between gap-6 px-6 py-4">
        <Link
          href="/"
          className="text-sm font-semibold tracking-tight text-ink transition-colors hover:text-ink-muted"
        >
          AI Engineer Daily
        </Link>
